...
BEGIN
  ...
  WITH all_content AS (
      SELECT 
          p.id, p.user_id, p.caption, p.image_url, NULL::text as video_url, p.thumbnail_url,
      ...
      UNION ALL
      SELECT 
          r.id, r.user_id, r.caption, NULL::text as image_url, r.video_url, r.thumbnail_url,
