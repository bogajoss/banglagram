...
export default function AuthView() {
  ...
  const cardBg =
    theme === "dark" ? "bg-zinc-900 border border-zinc-800" : "bg-white shadow";
  ...
  if (isRegistrationSuccess) {
    return (
      ...
      >
        <div
          className={`relative w-full max-w-md p-8 sm:p-10 rounded-3xl transition-colors duration-300 ${cardBg} text-center`}
        >
  ...
  return (
    ...
    >
      <div
        className={`relative w-full max-w-md p-8 sm:p-10 rounded-3xl transition-colors duration-300 ${cardBg}`}
      >
        <div className="max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <>
                <div>
                  <label
                    className={`font-semibold text-xs ${labelColor} pb-1 block`}
                  >
                    Username
                  </label>
                  <input
          ...
          <div className="my-8 flex items-center justify-between">
            <span
              className={`w-1/4 border-b ${theme === "dark" ? "border-zinc-800" : "border-gray-200"}`}
            ></span>
