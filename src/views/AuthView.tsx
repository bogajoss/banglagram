...
export default function AuthView() {
  ...
  if (isRegistrationSuccess) {
    return (
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300 bg-muted">
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300 bg-muted">
      <Card className="w-full max-w-md shadow-2xl border-none">
        <CardHeader className="space-y-1 flex flex-col items-center">
          ...
          <CardTitle className="text-3xl font-bold text-[#006a4e]">
            Banglagram
          </CardTitle>
