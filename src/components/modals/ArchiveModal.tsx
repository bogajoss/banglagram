        ...
        >
            ...
            >
                ...
                <div className="h-64 flex flex-col items-center justify-center p-6 text-center opacity-70">
                    <div className={`p-4 rounded-full mb-4 ${theme === 'dark' ? 'bg-zinc-800' : 'bg-gray-100'}`}>
                        <Archive size={32} />
                    </div>
                    <h3 className="font-bold text-lg mb-1">আর্কাইভে কিছু নেই</h3>
                    <p className="text-sm">আপনি যখন পোস্ট বা স্টোরি আর্কাইভ করবেন, তখন সেগুলো এখানে দেখা যাবে।</p>
                </div>
