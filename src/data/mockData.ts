...
চলো জীবনটা প্যরাহীন করি 🔥`,
  ...
  stories: [
    {
      ...
      img: "https://images.unsplash.com/photo-1528164344705-47542687000d?w=800&auto=format&fit=crop&q=60",
    },
    {
      id: 102,
      username: "your_story",
      img: "https://images.unsplash.com/photo-1511765224389-37f0e77cf0eb?w=800&auto=format&fit=crop&q=60",
      isUser: true,
    },
    {
      id: 103,
      username: "friend_1",
      img: "https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?w=800&auto=format&fit=crop&q=60",
    },
    {
      id: 104,
      username: "friend_2",
    ...
    },
    {
      id: 105,
      username: "friend_3",
      img: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=800&auto=format&fit=crop&q=60",
    },
  ],
  notes: [
    {
    ...
    },
    {
      ...
      user: {
        ...
        avatar:
          "https://api.dicebear.com/9.x/avataaars/svg?seed=leniepabelonia_",
      },
      text: "জিম টাইম 💪",
    },
    {
      ...
      user: {
        ...
        avatar:
          "https://api.dicebear.com/9.x/avataaars/svg?seed=bolt.motivation",
      },
      text: "কাজ আর কাজ 😫",
    },
    {
      ...
      user: {
        ...
        avatar:
          "https://api.dicebear.com/9.x/avataaars/svg?seed=nutshell_today",
      },
      text: "নতুন ভিডিও আসছে!",
    },
  ],
  posts: [
    {
    ...
    },
    {
      ...
      content: {
        type: "image",
        src: "https://images.unsplash.com/photo-1515378960530-7c0da6231fb1?w=800&auto=format&fit=crop&q=60",
      },
      likes: "৩১৭.৮K",
      caption:
        "তাড়াহুড়ো করার জন্য বড্ড ছোট, কিন্তু সময় নষ্ট করার জন্য বড্ড বড়।",
      comments: 479,
      time: "১২ঘ",
      isVerified: false,
      commentList: [],
    },
    {
      ...
      content: {
        type: "image",
        src: "https://images.unsplash.com/photo-1571019613454-1cb2f98b2d8b?w=800&auto=format&fit=crop&q=60",
      },
      likes: "১.৩K",
    ...
    },
    {
      ...
      likes: "৩.৫K",
      caption:
        "অস্ট্রেলিয়ার স্বরাষ্ট্র দপ্তর বাংলাদেশকে অ্যাসেসমেন্ট লেভেল ১ থেকে লেভেল ৩ (সর্বোচ্চ ঝুঁকিপূর্ণ) এ নামিয়ে দিয়েছে।",
      comments: 76,
      time: "৪ঘ",
      isVerified: true,
      commentList: [],
  ...
  messages: [
    {
      ...
      chatHistory: [
        ...
        },
        {
          ...
          caption:
            "💹 মাইক্রোসফট এক্সেলে সঠিক দক্ষতা না থাকার কারনে অফিসে বসের রেগুলার ঝারি খাচ্ছেন? ডাটা র‍্যাংকিং,কম্বাইনিং টেক্সট...",
          timestamp: "০৯:৪৯",
        },
        { type: "date", text: "২৯ ডিসেম্বর ২০২৫" },
        {
          ...
          avatar:
            "https://api.dicebear.com/9.x/avataaars/svg?seed=fariyakabir_22",
          timestamp: "২২:০৯",
        },
        {
          type: "incoming",
  ...
  suggestedUsers: [
    {
      username: "shahriar_0sman",
      name: "Shahriar Osman",
      subtitle: "আপনার জন্য প্রস্তাবিত",
      avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=shahriar_0sman",
    },
    {
      username: "hasanatrn121",
      name: "Hasanat Jahin Ratun",
      subtitle: "আপনার জন্য প্রস্তাবিত",
      avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=hasanatrn121",
    },
    {
      username: "nafis_sadique_orko",
      name: "nafis sadique",
      subtitle: "আপনার জন্য প্রস্তাবিত",
      avatar:
        "https://api.dicebear.com/9.x/avataaars/svg?seed=nafis_sadique_orko",
    },
    {
      username: "nfa.rha",
      name: "Navila Farha",
      subtitle: "আপনার জন্য প্রস্তাবিত",
      avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=nfa.rha",
    },
    {
      username: "estiak_ifan_75_",
      name: "Md Eastiak Ifan",
      subtitle: "আপনার জন্য প্রস্তাবিত",
      avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=estiak_ifan_75_",
    },
    {
      username: "dipa_aaaaaa_",
      name: "Dipa✨",
      subtitle: "_n4w5h1n_ ফলো করেন",
      avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=dipa_aaaaaa_",
    },
    {
      username: "mn0033975",
      name: "Md Nayem",
      subtitle: "আপনার জন্য প্রস্তাবিত",
      avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=mn0033975",
    },
    {
      username: "likhon_shil_",
      name: "Likhon Shil",
      subtitle: "আপনার জন্য প্রস্তাবিত",
      avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=likhon_shil_",
    },
  ],
  reels: [
    {
      id: 501,
      user: {
        username: "maybe__tisha",
        avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=maybe__tisha",
      },
    ...
    },
    {
      id: 502,
      user: {
        username: "midnight_rebel69",
        avatar:
          "https://api.dicebear.com/9.x/avataaars/svg?seed=midnight_rebel69",
      },
    ...
    },
    {
      ...
      user: {
        username: "speediety",
        avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=speediety",
      },
